# Gentium Plus WSP [![Build Status](http://build.palaso.org/app/rest/builds/buildType:Fonts_GentiumWspx/statusIcon)](http://build.palaso.org/viewType.html?buildTypeId=Fonts_GentiumWspx&guest=1) 
